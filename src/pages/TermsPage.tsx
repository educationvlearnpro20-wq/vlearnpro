      ...
      <section style={{ paddingTop: '2.5rem', paddingBottom: '4.5rem' }}>
        <div className="container" style={{ maxWidth: '880px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', fontSize: '0.95rem', lineHeight: 1.7, color: 'var(--text-secondary)' }}>
            ...
            <div>
              <h2 style={{ color: 'var(--text-primary)', fontSize: '1.35rem', marginBottom: '0.75rem' }}>1. Acceptance of Terms</h2>
              <p>
            ...
            <div>
              <h2 style={{ color: 'var(--text-primary)', fontSize: '1.35rem', marginBottom: '0.75rem' }}>2. Description of Educational Services</h2>
              <p>
            ...
            <div>
              <h2 style={{ color: 'var(--text-primary)', fontSize: '1.35rem', marginBottom: '0.75rem' }}>3. Free 1-on-1 Trial Class Policy</h2>
              <p>
            ...
            <div>
              <h2 style={{ color: 'var(--text-primary)', fontSize: '1.35rem', marginBottom: '0.75rem' }}>4. Rescheduling & Cancellation Rules</h2>
              <p>
            ...
            <div>
              <h2 style={{ color: 'var(--text-primary)', fontSize: '1.35rem', marginBottom: '0.75rem' }}>5. Academic Integrity & Performance Disclaimer</h2>
              <p>
            ...
            <div>
              <h2 style={{ color: 'var(--text-primary)', fontSize: '1.35rem', marginBottom: '0.75rem' }}>6. Contact Information</h2>
